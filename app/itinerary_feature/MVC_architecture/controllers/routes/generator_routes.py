...
from app.itinerary_feature.MVC_architecture.controllers.itinerary_generator_controller import (
    generate_itinerary,
...
generator_bp.add_url_rule(
    ...
    view_func=submit_operator_time_data,
    methods=["POST"],
)
...
generator_bp.add_url_rule(
    ...
    view_func=ingest_visit_duration,
    methods=["POST"],
)
