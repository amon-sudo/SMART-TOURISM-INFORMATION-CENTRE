...
def create_attraction():
    ...
    try:
        ...
        attraction = Attraction(
            ...
            types_of_experiences=data.get("types_of_experiences"),
            avg_time_spent=data.get("avg_time_spent"),
            best_visiting_periods=data.get("best_visiting_periods"),
            key_events=data.get("key_events"),
            roads_condition=data.get("roads_condition"),
            visitor_center_info=data.get("visitor_center_info"),
            water_supply=data.get("water_supply"),
            signage_info=data.get("signage_info"),
            fencing_security=data.get("fencing_security"),
            parking_area=data.get("parking_area"),
            rest_areas=data.get("rest_areas"),
            site_current_status=data.get("site_current_status"),
            tour_operators=data.get("tour_operators"),
            nearby_accommodation=data.get("nearby_accommodation"),
            distance_to_major_town=data.get("distance_to_major_town"),
        )
