...
Cross-feature service layer (pricing, payment utilities, references, storage, and generators).
...
## Endpoint Testing
This feature has no direct HTTP routes in this folder; it is consumed by other routed modules.
